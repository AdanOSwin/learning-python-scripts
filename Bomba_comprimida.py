...
if __name__ == '__main__':
	...
	end_time = time.time()
	print 'Tamaño del archivo comprimido: %.2f KB'%(get_file_size(out_zip_file)/1024.0)
	print 'Tamaño Descompreso: %d GB'%decompressed_size
	print 'Tiempo de generacion: %.2fs'%(end_time - start_time)
